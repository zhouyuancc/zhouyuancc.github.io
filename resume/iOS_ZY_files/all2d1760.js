...
{
if(_oTop.isCanConnectGoogle.result===undefined)
{
_oTop.isCanConnectGoogle.result=false;
createIframe(_oTop,["javascript:(function(){document.open();document.domain='",document.domain,"';document.close();})()"].join(""),{onload:function(b,d,c){
isCanConnectGoogleCheck(c,a);
}});
}
}
...
loadJsFileToTop(["$js_path$com/kits/qmeditor/qqmail/release/editor2bff8a.js"]);
...
var oDomainBlackListXss=["qqshow.mail.qq.com"];
function isInBlackList(a)
{
var b=false;
for(var c=0,d=oDomainBlackListXss.length;c<d;c++)
{
if(new RegExp("^(https:|http:)?//"+oDomainBlackListXss[c],"ig").test(a))
{
b=true;
break;
}
...
if(c&&/^https?:\/\/([\w]+\.)?mail\.qq\.com(\/)/i.test(c)&&!isInBlackList(c))
{
...
},doGoogleOauth:function(a,G){
var w=getTop(),r=this,C=a._sPopmail,D=a._sPoppwd,p=r._oDialog.S("ipt_pwd"),f=r._oDialog.S("geConfirmBtn");
if(w.attr(f,"oauth")=="true")
{
return;
}
var I=function(){
w.attr(f,"oauth","true");
w.addClass(f,"qui_btn_BlueDisabled");
};
var K=function(){
w.attr(f,"oauth","false");
w.rmClass(f,"qui_btn_BlueDisabled");
};
var j=r._oDialog.S("div_verifycode"),x=r._oDialog.S("verifyImage"),m=r._oDialog.S("loginData"),l=r._oDialog.S("loginCookies"),n=r._oDialog.S("loginVerify");
var i=r._oDialog.S("div_secondFactor"),u=r._oDialog.S("smsData"),t=r._oDialog.S("smsCookies"),s=r._oDialog.S("smsAction"),v=r._oDialog.S("smsUserPin");
var h=r._oDialog.S("div_challenge"),e=r._oDialog.S("challengeData"),d=r._oDialog.S("challengeCookies"),o=r._oDialog.S("phoneNumber"),y=r._oDialog.S("verifySmsChallengeAnswer"),k=r._oDialog.S("emailAnswer"),g=r._oDialog.S("deviceAddress"),q=r._oDialog.S("secretAnswer"),c=r._oDialog.S("challengeTip");
var J=function(L,M){
...
if(L=="VerifySmsChallenge")
{
y.style.display="";
y.value="";
c.innerHTML="(\u8BF7\u8F93\u5165\u4F60\u7684Gmail\u5E10\u53F7\u7ED1\u5B9A\u7684\u624B\u673A\u53F7\u7801\u6536\u5230\u7684\u77ED\u4FE1\u9A8C\u8BC1\u7801)";
y.focus();
}
else if(L=="PhoneVerificationChallenge")
{
o.style.display="";
o.value="";
c.innerHTML="(\u8BF7\u8F93\u5165\u4F60\u7684Gmail\u5E10\u53F7\u7ED1\u5B9A\u7684\u624B\u673A\u53F7\u7801\u6765\u5B8C\u6210\u8EAB\u4EFD\u9A8C\u8BC1)";
o.focus();
}
else if(L=="UnverifiedPhoneChallenge")
{
g.style.display="";
g.value="";
c.innerHTML="(\u8BF7\u8F93\u5165\u4F60\u7684Gmail\u5E10\u53F7\u7ECF\u5E38\u767B\u5F55\u7684\u4F4D\u7F6E\u6765\u5B8C\u6210\u8EAB\u4EFD\u9A8C\u8BC1)";
g.focus();
}
else if(L=="SecretQuestionChallenge")
{
q.style.display="";
q.value="";
c.innerHTML='(\u8BF7\u56DE\u7B54\u5BC6\u4FDD\u95EE\u9898 \u201C<span style="color:red;">'+M+'</span>\u201D \u6765\u5B8C\u6210\u8EAB\u4EFD\u9A8C\u8BC1)';
q.focus();
}
else if(L=="RecoveryEmailChallenge")
{
k.style.display="";
k.value="";
c.innerHTML="(\u8BF7\u8F93\u5165\u4F60\u7684Gmail\u5E10\u53F7\u7ED1\u5B9A\u7684\u8F85\u52A9\u90AE\u7BB1\u5730\u5740\u6765\u5B8C\u6210\u8EAB\u4EFD\u9A8C\u8BC1)";
k.focus();
}
else{
...
{
var H=["smsAction="+s.value,"smsUserPin="+v.value,"smsData="+u.value,"smsCookies="+t.value].join("&");
if(j.style.display!="none")
{
H=[H,"strongauthcaptcha="+n.value].join("&");
}
if(!v.value)
{
v.focus();
r.showWarn("\u4F60\u8FD8\u6CA1\u6709\u8F93\u5165\u9A8C\u8BC1\u7801");
K();
return;
}
w.showInfo("\u6B63\u5728\u9A8C\u8BC1\u5176\u4ED6\u90AE\u7BB1\u5E10\u53F7...");
w.QMAjax.send("/cgi-bin/googleoauth/secondFactor",{content:H,method:"POST",onload:function(L,M){
var N=w.evalValue(M);
if(L)
{
if(!N.errCode&&N["access_token"])
{
w.LogKV("getinvestigate|googleoauth|oauth|success");
w.ossLog('delay','all','kw=google_oauth_suc&value=1');
G&&G(N);
}
else if(N.errCode=="104")
{
K();
if(N.verifyImageUri)
{
x.setAttribute("src",decodeURIComponent(N.verifyImageUri)+"&sid="+w.getSid());
n.value="";
j.style.display="";
}
else{
...
s.value=N.smsAction;
u.value=N.smsData;
t.value=N.smsCookies;
r.showWarn("\u4E24\u6B65\u767B\u5F55\u9A8C\u8BC1\u5931\u8D25\uFF0C\u8BF7\u91CD\u65B0\u8F93\u5165");
}
else if(N.errCode=="105")
{
K();
j.style.display="none";
i.style.display="none";
e.value=N.challengeData;
d.value=N.challengeCookies;
h.style.display="";
J(N.challengeType,N.secretQuestion);
}
else{
N.errType&&w.LogKV("getinvestigate|googleoauth|fail|"+N.errType);
w.LogKV("getinvestigate|googleoauth|oauth|fail");
j.style.display="none";
i.style.display="none";
r.doRealAction(a);
}
...
{
var H=["Email="+C,"&Passwd="+D,"&logincaptcha="+n.value,"&loginData="+m.value,"&loginCookies="+l.value].join("");
if(!n.value)
{
n.focus();
r.showWarn("\u4F60\u8FD8\u6CA1\u6709\u8F93\u5165\u9A8C\u8BC1\u7801");
...
w.showInfo("\u6B63\u5728\u9A8C\u8BC1\u5176\u4ED6\u90AE\u7BB1\u5E10\u53F7...");
w.QMAjax.send("/cgi-bin/googleoauth/verifyLogin",{content:H,method:"POST",onload:function(L,M){
var N=w.evalValue(M);
if(L)
{
if(!N.errCode&&N["access_token"])
...
else if(N.errCode=="101")
{
K();
j.style.display="none";
p.value="";
p.focus();
r.showWarn("\u5E10\u53F7\u6216\u8005\u5BC6\u7801\u9519\u8BEF\uFF0C\u8BF7\u68C0\u67E5");
}
else if(N.errCode=="102")
{
K();
x.setAttribute("src",decodeURIComponent(N.verifyImageUri)+"&sid="+w.getSid());
m.value=N.data;
...
else if(h.style.display!="none")
{
var z,B;
var b=false;
if(y.style.display!="none")
{
z=[e.value,"challengetype%3DVerifySmsChallenge","VerifySmsChallengeAnswer%3D"+y.value.replace(/^G-?/i,"")].join("%26");
B="VerifySmsChallenge";
if(!y.value)
{
b=true;
y.focus();
...
{
z=[e.value,"challengetype%3DPhoneVerificationChallenge","phoneNumber%3D"+o.value].join("%26");
B="PhoneVerificationChallenge";
if(!o.value)
{
b=true;
o.focus();
...
{
z=[e.value,"challengetype%3DUnverifiedPhoneChallenge","deviceAddress%3D"+g.value].join("%26");
B="UnverifiedPhoneChallenge";
if(!g.value)
{
b=true;
g.focus();
...
{
z=[e.value,"challengetype%3DSecretQuestionChallenge","answer%3D"+q.value].join("%26");
B="SecretQuestionChallenge";
if(!q.value)
{
b=true;
q.focus();
...
z=[e.value,"challengetype%3DRecoveryEmailChallenge","emailAnswer%3D"+k.value].join("%26");
B="RecoveryEmailChallenge";
if(!k.value)
{
b=true;
k.focus();
...
w.showInfo("\u6B63\u5728\u9A8C\u8BC1\u5176\u4ED6\u90AE\u7BB1\u5E10\u53F7...");
var H=["challengeData="+z,"&challengeCookies="+d.value].join("");
w.QMAjax.send("/cgi-bin/googleoauth/challenge",{content:H,method:"POST",onload:function(L,M){
var N=w.evalValue(M);
if(L)
{
if(!N.errCode&&N["access_token"])
...
else if(N.errCode=="106")
{
K();
w.LogKV("getinvestigate|googleoauth|oauth|challengefail");
e.value=N.challengeData;
d.value=N.challengeCookies;
r.showWarn("\u8EAB\u4EFD\u9A8C\u8BC1\u5931\u8D25\uFF0C\u8BF7\u91CD\u65B0\u9A8C\u8BC1");
if(B=="VerifySmsChallenge")
{
y.value="";
y.focus();
}
else if(B=="PhoneVerificationChallenge")
{
o.value="";
o.focus();
}
else if(B=="UnverifiedPhoneChallenge")
{
g.value="";
g.focus();
}
else if(B=="SecretQuestionChallenge")
{
q.value="";
q.focus();
}
...
var H="Email="+C+"&Passwd="+D;
w.showInfo("\u6B63\u5728\u9A8C\u8BC1\u5176\u4ED6\u90AE\u7BB1\u5E10\u53F7...");
w.QMAjax.send("/cgi-bin/googleoauth",{content:H,method:"POST",onload:function(L,M){
var N=w.evalValue(M);
if(L)
{
if(!N.errCode&&N["access_token"])
...
var a={'comm2010.css':'$css_path$comm20102b88c9.css'};
return function(b){
var c=a[b];
return c&&getRes(c);
};
